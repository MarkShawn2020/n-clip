        ...
        <div className="permission-dialog-content">
          ...
          {permissionStatus === 'denied' && !showInstructions && (
            <div className="permission-request">
              ...
              <h3>需要辅助功能权限</h3>
              <p>为了实现 Alfred 风格的直接文本插入功能，N-Clip 需要访问辅助功能权限。</p>
              <p>这将允许 N-Clip 直接将文本插入到其他应用程序的输入框中，而不需要手动粘贴。</p>
          ...
          {showInstructions && (
            <div className="permission-instructions">
              ...
              <ol className="instruction-steps">
                ...
                <li>在右侧列表中找到 <strong>"N-Clip"</strong> 并勾选</li>
                <li>重启 N-Clip 以生效</li>
              </ol>
          ...
          {permissionStatus === 'granted' && (
            <div className="permission-success">
              ...
              <h3>权限已授予！</h3>
              <p>N-Clip 现在可以直接将文本插入到其他应用程序中。</p>
