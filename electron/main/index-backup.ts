...
// Temporarily disable native accessibility module to fix segfault
// import { 
...
// Temporary stub functions to replace native accessibility functions
const checkAccessibilityPermission = () => true
const getFocusedAppInfo = () => ({ appName: 'Unknown', processId: 0 })
const simulatePasteKeystroke = () => true
